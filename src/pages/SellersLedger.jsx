        ...
        <div className="space-y-6">
            ...
            {showLedgerModal && selectedSeller && (
                <div className="fixed inset-0 z-50 flex items-center justify-center py-6 sm:py-10 px-2 sm:px-4 bg-black/60 backdrop-blur-sm">
                    <div id="print-modal" className="bg-white rounded-xl shadow-2xl w-full max-w-5xl h-full flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom duration-300">
                        <div className="flex justify-between items-center p-4 sm:p-6 border-b border-gray-200 bg-gray-50">
                            <div>
                                <h2 className="text-xl sm:text-2xl font-bold text-gray-900">{selectedSeller.name} - Ledger</h2>
                                    ...
                                    <table className="w-full text-left text-xs sm:text-sm min-w-[700px]">
                                        <thead className="bg-slate-100 text-gray-700 uppercase font-medium">
                                            <tr>
                                                ...
                                                <th className="p-3 text-center no-print">Del</th>
                                            </tr>
                                        </thead>
                                        <tbody>
