...
const BuyItems = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!sellerId) {
                alert('Please select or create a seller');
                return;
            }
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-6">
            <h1 className="text-2xl font-bold text-gray-800">{t('Buy Items (From Broker)')}</h1>
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 space-y-6 text-gray-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <div>
                        <label className="block text-sm font-medium mb-1">{t('Select Seller')}</label>
                        {!isNewSeller ? (
                            ...
                            <div className="flex flex-col gap-2">
                                <input type="text" placeholder={t('Seller Name')} required className="w-full p-2 border border-gray-300 rounded" value={newSellerName} onChange={e => setNewSellerName(e.target.value)} />
                                <div className="flex gap-2">
